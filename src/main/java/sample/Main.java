...
public class Main extends Application {
    ...
    private void dataLoader(){
        ...
        map.put("RTB",new CodeDTO("RTB", "Roots Tap Barrel", " Individual roots that are estimated to be greater than 0.5 inch in diameter enters along the body/wall of the pipe."));
        map.put("RTC",new CodeDTO("RTC", "Roots Tap Connection", " Individual roots that are estimated to be greater than 0.5 inch in diameter enters the pipe around the outside edge of a service pipe or tap at the interface between the lateral and the main pipe."));
        ...
        map.put("ACO",new CodeDTO("ACO", "Access Point Interior Floor Cleanout", "  Provides access to the pipe(s) for maintenance and inspection. The interior floor cleanout is typically a 2.5 to 6 inches round, threaded cap (also referred to as a plug�) located in the floor of the basement, usually at/near the wall where the underground sewer line exits to the exterior of the structure."));
        map.put("AEO",new CodeDTO("AEO", "Access Point Exterior Cleanout", " Provides access to the pipe(s) for maintenance and inspection. The interior floor cleanout is typically a 3 to 6 inches round, threaded cap (also referred to as a plug�) located to the exterior of the structure. Though normally located at/near the exterior wall of the structure, there may also be cleanouts/additional cleanouts located further down the pipe, especially in longer lines."));
        map.put("AVO",new CodeDTO("AVO", "Access Point Vertical Stack Cleanout", " Provides access to the pipe(s) for maintenance and inspection. The vertical stack cleanout is typically a 2.5 to 6 inches round, threaded cap (also referred to as a plug�) located on the a basement vertical sewage pipe (stack) that runs from the vent at the roof,  to the connection to the sanitary line beneath the basement slab."));
        map.put("AHP",new CodeDTO("AHP", "Access Point Horizontal Pipe Cleanout", " Provides access to the pipe(s) for maintenance and inspection. The horizontal pipe cleanout is typically a 2.5 to 6 inches round, threaded cap (also referred to as a plug�) located in an above ground horizonal pipe that runs to and taps into the main sanitary line. "));
        map.put("AHO",new CodeDTO("AHO", "Access Point Hung Sewer Cleanout", " Provides access to the pipe(s) for maintenance and inspection. The hung sewer cleanout is typically a 3 to 4 inches round, threaded cap (also referred to as a plug�) normally located in the basement at the beginning of the horizontal mainline. Rather than exiting the house beneath the floor a hung sewer begins/exits through the foundation wall�above the basement slab."));
        map.put("ATO",new CodeDTO("ATO", "Access Point Toilet Flange", " The toilet flange access is usually located in the floor and is typically 3 to 4. Flanges may only be accessed by pulling/removing the toilet. Due to upper level toilets usually connecting to a vertical stack at a sharp 90-degree bend. The main sewer line may likely only be accessible through a basement toilet flange which typically has a wide 90-degree sweep. "));
